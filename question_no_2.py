...
class calculator:
	...
	def initialize_buttons(self):
		...
		button1 = Button(self.root1, text = '1',padx=40,pady=20 ,command = lambda:self.show_my_num(1) , bg = self.theme,font = 10)
		button2 = Button(self.root1, text = '2',padx=40,pady=20,command = lambda:self.show_my_num(2), bg = self.theme,font = 10)
		button3 = Button(self.root1, text = '3',padx=40,pady=20,command =lambda: self.show_my_num(3), bg = self.theme,font = 10)

		button4 = Button(self.root1, text = '4',padx=40,pady=20,command =lambda: self.show_my_num(4), bg = self.theme,font = 10)
		button5 = Button(self.root1, text = '5',padx=40,pady=20,command =lambda: self.show_my_num(5), bg = self.theme,font = 10)
		button6 = Button(self.root1, text = '6',padx=40,pady=20,command =lambda: self.show_my_num(6), bg = self.theme,font = 10)

		button7 = Button(self.root1, text = '7',padx=40,pady=20,command =lambda: self.show_my_num(7), bg = self.theme,font = 10)
		button8 = Button(self.root1, text = '8',padx=40,pady=20,command =lambda: self.show_my_num(8), bg = self.theme,font = 10)
		button9 = Button(self.root1, text = '9',padx=40,pady=20,command =lambda: self.show_my_num(9), bg = self.theme,font = 10)

		button_zero = Button(self.root1, text = '0',padx=40,pady=20,command =lambda: self.show_my_num(0), bg = self.theme,font = 10)
		button_plus = Button(self.root1, text = '+',padx=40,pady=20,command = lambda: self.operator('+'), bg = self.theme,font = 10)
		button_equal = Button(self.root1, text = '=',pady=20,command = self.equal_operator, bg = self.theme,font = 10)

		button_sub = Button(self.root1, text = '-',padx=40,pady=20,command = lambda: self.operator('-'), bg = self.theme,font = 10)
		button_mul = Button(self.root1, text = '*',padx=40,pady=20,command = lambda: self.operator('*'), bg = self.theme,font = 10)
		button_clear = Button(self.root1, text = 'clear',padx=30,pady=20,command = self.clear_all, bg = self.theme,font = 10)
		button_div = Button(self.root1, text = '/',padx=40,pady=20,command = lambda: self.operator('/'), bg = self.theme,font = 10)
